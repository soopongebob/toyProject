...
public class HomeController {
    ...
    public String home(Model model, HttpServletRequest request,
        ...
        Page<Article> weeklyArti = articleService.getWeeklyList(pageable);
        Page<ArticleListForm> articleList = new ArticleListForm().toList(articles);
        Page<ArticleListForm> weeklyList = new ArticleListForm().toList(weeklyArti);

        model.addAttribute("articles", articleList);
        model.addAttribute("weekly", weeklyList);
        return "index";
    }
